...
function Table($header, $data)
{
    ...
    $this->Cell($t[1],6,chr(128) . number_format($totaal),'',0,'L', true);
    $this->Ln(10);
}
function ending(){
    global $totaal;
    ...
    $this->Cell(70);
    $this->Cell(30,10,chr(128) . number_format($totaal) . ' Te betalen ten laatste op: ' . date('d/m/y', strtotime(date('y-m-d') . ' + 7 days')),0,0,'L');
    $this->Ln(10);
