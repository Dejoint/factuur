...
<div class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <h1 class="h2">Gebruiker verwijderen</h1>
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" class="form-horizontal">
        <div class="form-group">
            <div class="col-sm-12">
                <p>Weet je zeker dat je gebruiker <strong><?php echo $user['username'] ?></strong> wil verwijderen?</p>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-12">
                <button type="submit" class="btn btn-danger" id="btn-delete">
                    <i class="fa fa-btn fa-trash"></i> Gebruiker verwijderen
                </button>
            </div>
        </div>
    </form>
...
<footer class="footer mt-auto py-3">
    <div class="container">
        <span class="text-muted">&copy; 2020 Weerstation &mdash; Joran Anseau</span>
    </div>
</footer>
