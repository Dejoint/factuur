...
//    $stmt = $db->query('SELECT Id FROM user WHERE username = "' . $username .'"' );
  //  $exist = $stmt->fetch(PDO::FETCH_ASSOC);
    
    $stmt = $db-> prepare('INSERT INTO user (`username`, passw) VALUES (?,?)');
    $stmt->execute(array($username, $passencryp));
    ...
    <nav class="navbar navbar-default">
        <div class="container">
            <div class="navbar-header"><!-- Just an image -->
                ...
                <a class="navbar-brand" href="index.php">Registreren</a>
            </div>
