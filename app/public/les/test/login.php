...
if (isset($_POST['moduleAction']) && ($_POST['moduleAction'] == 'login')) {
    ...
    $stmt = $db->query('SELECT passw, Id FROM user WHERE username = "' . $username .'"' );
    $pass = $stmt->fetch(PDO::FETCH_ASSOC);
    var_dump($passencryp);
    if (password_verify($password, $pass['passw'])) {
    	$_SESSION['user'] = array( 'username' => $username, 'id' => $pass['Id']);
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="password" class="col-sm-3 control-label">Pasword</label>
